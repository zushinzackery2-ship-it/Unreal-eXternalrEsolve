#pragma once
// Unreal-eXternalrEsolve - SDK 导出：附加格式
...
inline bool DumpOffsetTable(const std::wstring& outputPath)
{
    ...
    file << "// Offset dump by Unreal-eXternalrEsolve\n\n";
...
inline bool DumpMapping(const std::wstring& outputPath)
{
    ...
    file << "// Mapping dump by Unreal-eXternalrEsolve\n\n";
...
inline bool DumpSpaceSdk(const std::wstring& outputPath)
{
    ...
    // GObjects-Dump.txt — 不带属性
    {
        ...
        file << "Object dump by Unreal-eXternalrEsolve\n\n";
        file << "Count: " << total << "\n\n\n";
    ...
    std::cerr << "[unreal] GObjects-Dump 导出完成: "
              << total << " 个对象\n";
    return true;
}
