#pragma once
// Unreal-eXternalrEsolve - SDK 生成：辅助文件
...
/*
* SDK generated by Unreal-eXternalrEsolve
* Based on Dumper-7
*
...
inline void GenerateNameCollisions(
    ...
    const std::vector<unreal::detail::StructEntry>& entries)
{
...
// FORWARD DECLARATIONS
    ...
    for (auto& e : entries)
    {
        ...
        {
            std::string prefixed = unreal::detail::AddStructPrefix(
                e.name, e.isClass,
